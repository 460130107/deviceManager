  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div style="margin-left: 280px;">
        ...
        <button onclick="downloadDevInfo(${sessionScope.user.userRole})" class="btn btn-primary" style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;导出&nbsp;&nbsp;&nbsp;&nbsp;</button>
      </div>
    </div>
  </div><!--/.row-->
  <div class="row">
        ...
        <div class="panel-body">
          <table id="devInfoTable" data-toggle="table" data-pagination="true">
            ...
            <tr>
              ...
              <th data-field="devAvbNum">可用数量</th>
            </tr>
            </thead>
          </table>
        </div>
